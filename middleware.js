...
// `matcher` below (setup-assistant.md, fleet-control-centre.html, the
// assets/fleet_screenshots/ folder, and the openclaw/ folder), which stay
// fully public.
//
...
export const config = {
  ...
  matcher: ['/((?!setup-assistant\\.md$|fleet-control-centre\\.html$|assets/fleet_screenshots/|openclaw/|favicon\\.ico$|_vercel(?:$|/)).*)'],
}
